...
sequelize.sync({
  ...
  var _yield$SRUser$findByP, _yield$SRUser$findByP2, resUser, cacheHit, orgUser;
  ...
  return _regenerator["default"].wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          _yield$SRUser$findByP = _context.sent;
          _yield$SRUser$findByP2 = (0, _slicedToArray2["default"])(_yield$SRUser$findByP, 2);
          resUser = _yield$SRUser$findByP2[0];
          cacheHit = _yield$SRUser$findByP2[1];
